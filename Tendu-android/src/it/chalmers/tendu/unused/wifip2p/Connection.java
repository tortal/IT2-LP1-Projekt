...
public class Connection {
	...
	public interface OnIncomingConnectionListener {
		public void OnIncomingConnection(WifiP2pDevice device);
	}
	...
	public interface OnMessageReceivedListener {
		public void OnMessageReceived(WifiP2pDevice device,
				EventMessage receivedObject);
	}

	public interface OnConnectionLostListener {
		public void OnConnectionLost(WifiP2pDevice device);
	}
	...
	public int sendMessage(WifiP2pDevice device, EventMessage message) {
