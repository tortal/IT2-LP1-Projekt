...
public class Constants {
	...
	public static final String SERVER_NAME = " - " + APP_NAME + 'S'; //used to change bluetooth name
	public static final String CLIENT_NAME = " - " + APP_NAME + 'C'; //used to change bluetooth name
