...
public class C {
	...
	public enum Msg {
		...
		TEST, ALL_PLAYERS_CONNECTED, LOBBY_READY, LOAD_GAME, NUMBER_GUESS, UPDATE_MODEL, PLAYER_CONNECTED, CONNECTION_LOST, REMOVE_TIME, PLAYER_READY, UPDATE_LOBBY_MODEL, START_MINI_GAME, GAME_SESSION_MODEL, SHAPE_SENT, LOCK_ATTEMPT, LOCK_FINISHED, CREATE_SCREEN, WAITING_TO_START_GAME, SOUND_WON, SOUND_LOST, SOUND_SUCCEED, SOUND_FAIL, INTERIM_FINISHED, GAME_RESULT, SHOW_INTERIM_SCREEN;
